...
colnames(Report)<-c("date","mean steps - ignore NA","mean steps - estimate NA based on mean for the interval","median steps - ignore NA","median steps - estimate NA based on mean for the interval")
Report
```
...
AIMWE<-ActivityIntervalMean[ActivityIntervalMean$weekend=="weekend",]
AIMWD<-ActivityIntervalMean[ActivityIntervalMean$weekend=="weekday",]
par(mfrow=c(2,1))
plot(AIMWD$interval,AIMWD$steps,type="l",
      main="Average Daily Steps By Time Interval - Weekday",xlab="Time Interval",
      ylab="Number of Steps")
plot(AIMWE$interval,AIMWE$steps,type="l",
      main="Average Daily Steps By Time Interval - Weekend",xlab="Time Interval",
      ylab="Number of Steps")
```
